 ...
 *
 *
 * This Plug-in was customized by dogrun Inc.
 * Data: 2014-02-12
 */
	...
	$.mcDropDownMenu = function(el, list, options){
		...
		$(document)
			...
			.bind("click", function(e){
				...
				if( $ul.length ){
					...
					//dogrun: .mc_parent is attached ul
		...
		function displayString(value){
            ...
            var displayval_length = displayValue(value).length
            var displayval =  displayValue(value)[displayval_length-1];
            return displayval;
		};
